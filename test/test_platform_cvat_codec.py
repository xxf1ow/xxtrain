...
class CvatCodecTest(unittest.TestCase):
    ...
    def test_literal_shapes_decode_by_frame_and_preserve_labels_and_extras(self):
        payload = {
            'version': 0,
            'shapes': [
                rectangle(frame=1, label_id=45, attribute_id=75, extra={'flags': {'reviewed': True}}),
                rectangle(frame=0, label_id=41, attribute_id=71, extra={'group_id': 9, 'description': '原始'}),
                rectangle(frame=1, label_id=42, attribute_id=72, extra={'custom': ['x', 2]}),
                rectangle(frame=0, label_id=44, attribute_id=74, extra={}),
                rectangle(frame=1, label_id=43, attribute_id=73, extra={'score': None}),
            ],
            'tracks': [],
            'tags': [],
        }
